...
?> 
            ...
            <td><a href="delete.php?id=<?php echo $row["id"]?>"><span class="glyphicon glyphicon-remove" > </span></a>
            <a href="update.php?id=<?php echo $row["id"]?>"><span class="glyphicon glyphicon-edit" > </span></a>
